...
@Data
@EqualsAndHashCode(callSuper = true, exclude = {"hospital", "citas", "historiaClinica"})
...
public class Paciente extends Persona {
    ...
    // Constructor manual para mantener la funcionalidad existente
    public Paciente(String nombre, String apellido, String dni, java.time.LocalDate fechaNacimiento,
    ...
    // Constructor generado por Lombok SuperBuilder
    /*
